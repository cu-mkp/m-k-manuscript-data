...
Quand tu moules ne frappe pas excessivement sur la medaille<br/> qui est en sable pource que cela lempesche de despouiller<br/> bien net & estonne le <span class="tl">moule</span>
...
## <span class="m">Sable de <span class="pl">Thoulouse</span></span>

 
Le <span class="del">bo</span> communement bon est <span class="m">celuy qui se trouve en une <span class="env">vigne de <span class="pl">puy<br/> david</span></span></span> Mays celuy qui est le plus excellent est <span class="m">celuy du <span class="pl">touch</span> pres<br/> de <span class="pl">Sainct Michel</span> & vers <span class="pl">blagnac</span> En une <span class="env">vigne qui est bien haulte</span></span><br/> Cestuy est plus delie & un peu plus gras que laultre & meilleur pour<br/> petits ouvrages Il ne veult pas estre trop recuit
