...
@ 
Les <span class="tl">mortiers</span> se font de la meilleure ligue de <span class="m">metal</span> & de fine <span class="m">rosette</span><br/> quon peult affin quils ne crevent poinct scavoir dune partye de <span class="m">metal</span><br/> & deulx de <span class="m">rosette</span> fine ou vieulx <span class="tl">chauldron</span> qui est encores mieulx<br/> Les uns sont de quinze ou dixsept <span class="ms">l<span class="exp">i</span>b<span class="exp">vre</span></span>. & se chargent de deulx <span class="ms">l<span class="exp">i</span>b<span class="exp">vre</span></span><br/> & demye de bonne <span class="m">pouldre</span> grenee & son pour apliquer aulx fenestres<br/> & portes communes Aultres sont du poix de 25 a 27 <span class="ms">l<span class="exp">i</span>b<span class="exp">vre</span></span> et se<br/> chargent de 4 <span class="ms">l<span class="exp">i</span>b<span class="exp">vre</span></span> de <span class="m">pouldre</span> Aultres de 4 s. <span class="ms">l<span class="exp">i</span>b<span class="exp">vre</span></span> poisant & se<br/> chargent de huict <span class="ms">l<span class="exp">i</span>b<span class="exp">vre</span></span> de <span class="m">pouldre</span> Et ainsy se forment selon leffort<br/> quilz ont affayre Il sont pardehors toutes dune venue Mays par<br/> dedans ilz sont faicts comme un <span class="tl">crusol</span> 
> *Figure*
