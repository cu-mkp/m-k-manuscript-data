...
13. THC (Terry Catapano) will merge unless there are conflicts to be resolved
...
MAKE YOUR CHANGES
git add . (this tells git to start tracking any files in the directory not already tracked. We shouldn&#39;t have created any new files, but good to do this just in case.)
git commit -m &#39;[#[issue] your message]&#39; (e.g., &#39;#73: change mould to mold&#39;)
(commits your changes to git and creates an automatic link in the commit message to the issue in question)
