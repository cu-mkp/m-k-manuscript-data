...
tools: [moule, presses de fer, tamis, manche, chaulderon, poelonne, chauderon, baston, ongle]
...
Pour gecter d<span class="m">or</span> <span class="del">il f</span> le <span class="m">crocum ferri</span> est necessaire @ &plus d<span class="m">alum<br/> de plume</span> quen la mixtion suivante la mixtion d<span class="m">alum de plume</span> ne peult rien<br/> gaster Il fault que le <span class="tl">moule</span> soict rouge & le serrer promptement avec des <span class="tl">presses<br/> de <span class="m">fer</span></span>
...
> 
> 
>   <span class="add">@celles des <span class="env">maisons</span> qui sont de <span class="m">terre<br/> aulcunem<span class="exp">ent</span> areneuse</span> semblent tenir plus<br/> au foeu</span>c_106v_01
...
Les petites <span class="al">tortues</span> estant sorties de loeuf sont bien<br/> gentilles a moulerc_106v_02
...
Le <span class="m">crocum ferri</span> est propre pour l<span class="m">or</span> Cest celuy qui estant<br/> mesle parmy le sable le recoit & le contient en sa chaleurc_106v_04
